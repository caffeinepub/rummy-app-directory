...
export class Backend implements backendInterface {
    ...
    async addApp(arg0: AppEntry): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllApps(): Promise<Array<AppEntry>> {
        if (this.processError) {
            try {
    ...
    async getFeaturedApps(): Promise<Array<AppEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFeaturedApps();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isAdminPhone(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isAdminPhone(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async registerAdminPhone(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.registerAdminPhone(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateApp(arg0: AppEntry): Promise<void> {
        if (this.processError) {
            try {
